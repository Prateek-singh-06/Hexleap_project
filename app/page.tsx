...
export default function Home() {
  ...
  return (
   <main className={`${dark?"dark":"light"} bg-costom `}>
    <div className="relative dark:bg-292B32 ">
      <div className="absolute top-4 right-5 ">
        <label className="cursor-pointer grid place-items-center">
  <input type="checkbox" title="input" checked={dark} value="synthwave" className="toggle  theme-controller bg-base-content row-start-1 col-start-1 col-span-2" onChange={handleCheckboxChange}/>
